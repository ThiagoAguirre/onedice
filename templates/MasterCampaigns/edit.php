...
$this->assign('title', 'Gênesis da Campanha — Editar');

// Register Lucide icons and view-specific assets
...
<div class="min-h-screen flex flex-col items-center justify-start p-4 sm:p-6 lg:p-8 relative">
    ...
    <aside id="menuDrawer" class="fixed top-0 right-0 h-full w-80 bg-white z-[60] shadow-2xl transform translate-x-full drawer-transition flex flex-col border-l border-[#E5E5E5]">
        ...
        <div class="flex-1 overflow-y-auto p-4 space-y-8">
            <!-- (Drawer sections omitted for brevity; identical to add view) -->
        </div>
        ...
        <?= $this->Form->create($masterCampaign, ['type' => 'file', 'class' => 'w-full grid grid-cols-1 lg:grid-cols-12 gap-6']) ?>
            ...
            <div class="lg:col-span-12 mt-6 pt-6 border-t border-[#E5E5E5] flex flex-col sm:flex-row items-center justify-between gap-6">
                ...
                <div class="flex items-center gap-3 w-full sm:w-auto">
                    <a href="<?= $this->Url->build(['action' => 'index']) ?>" class="flex-1 sm:flex-none px-6 py-2.5 rounded-xl border border-[#E5E5E5] text-xs font-bold uppercase tracking-widest text-[#666666] hover:bg-[#F5F5F5] hover:text-[#0F0F0F] transition-all bg-white shadow-sm">
                        Cancelar
                    </a>
